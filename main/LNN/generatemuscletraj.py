...
# #%%
# hor=45
# file = open('C:/Users/DellG5/Desktop/res2.mot', 'r')
# lines = file.readlines()
# new_lines = lines
# batch_states = []
# M=np.zeros((len(lines),43))
# for j in range(len(lines)):
#     if j>6:
#         a=lines[7].split()
#         for i in range(len(a)):
#             M[j,i]=float(lines[j].split()[i])
# batch_inputs = armid.getRandomInputs(n_batch=3, lb=[-5,-5], ub=[5,5], horizon=hor-1)*0

# states = numpy.zeros((hor , 4))
# for k in range(3):
    
#     for u in range(hor):
#         i=u*k+7
#         states[u, :] = [-pi/2+M[i,1]*0.0174533,M[i,3]*0.0174533,M[i,2]*0.0174533,M[i,4]*0.0174533]
