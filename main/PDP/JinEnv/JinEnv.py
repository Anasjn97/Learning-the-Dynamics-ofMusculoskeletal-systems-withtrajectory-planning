...
class RobotArm:
    ...
    def initDyn(self, l1=None, m1=None, l2=None, m2=None,c1=None, c2=None, c3=None, c4=None,b5=None,g=9.81):
        ...
        C = vertcat(C1, C2)
         ...
         #B1 = B[0,0]#*cos(self.q1)+B[0,1]*cos(self.q2)
        # B2= B[1,0]#*sin(self.q1)+B[1,1]*sin(self.q2)
        #B = vertcat(B1, B2)
    ...
    def initCost(self, wq1=None, wq2=None, wdq1=None, wdq2=None, wu=0.1,a=[math.pi / 2,0 , 0, 0]):
        # declare system parameters
        parameter = []
        if wq1 is None:
            self.wq1 = SX.sym('wq1')
    ...
    def initCosty2(self, wq1=None, wq2=None, wdq1=None, wdq2=None,l1=1,l2=1, wu=0.1,a=[math.pi / 2,0 , 0, 0]):
        # declare system parameters
        parameter = []
        if wq1 is None:
            self.wq1 = SX.sym('wq1')
        ...
        x1 = l1 * sin(self.q1)
        y1 = -l1 * cos(self.q1)
        x2 = l1*sin(self.q1)+l2*sin(self.q2)
        y2 = -l1*cos(self.q1)-l2*cos(self.q2)


        # cost for q1
        self.cost_q1 = 0*(self.q1 - x_goal[0]) ** 2
        # cost for q2
        self.cost_q2 = 0*(self.q2 - x_goal[1]) ** 2
        # cost for dq1
        self.cost_dq1 = (self.dq1 - x_goal[2]) ** 2
        # cost for q2
        self.cost_dq2 = (self.dq2 - x_goal[3]) ** 2
        ...
        self.cost_u = dot(self.U, self.U)
        #cost for final position
        self.cost_y2=(x2 - x_goal[4]) ** 2
        
        self.cost_x2=(y2 - x_goal[5]) ** 2

        self.path_cost = self.wq1 * self.cost_y2+self.wq1 * self.cost_x2+self.wq1 * self.cost_q1 + self.wq2 * self.cost_q2 + \
                         self.wdq1 * self.cost_dq1 + self.wdq2 * self.cost_dq2 + wu * self.cost_u
        self.final_cost = self.wq1 * self.cost_y2+self.wq1 * self.cost_x2+self.wq1 * self.cost_q1 + self.wq2 * self.cost_q2 + \
                          self.wdq1 * self.cost_dq1 + self.wdq2 * self.cost_dq2
